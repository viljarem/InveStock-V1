...
def get_portfolio_css() -> str:
    """Returnerer portefølje-spesifikk CSS med liquid glass-effekter."""
    return """
    <style>
    .portfolio-card {
        background: linear-gradient(135deg, 
    ...
    .alert-critical { 
        ...
        background: linear-gradient(135deg, 
            ...
            rgba(255, 23, 68, 0.06) 100%) !important;
        backdrop-filter: blur(12px) !important;
        -webkit-backdrop-filter: blur(12px) !important;
        border-radius: 12px !important;
        box-shadow: 0 4px 16px rgba(255, 23, 68, 0.2) !important;
    }
    ...
    .alert-high { 
        ...
        background: linear-gradient(135deg, 
            ...
            rgba(255, 145, 0, 0.06) 100%) !important;
        backdrop-filter: blur(12px) !important;
        -webkit-backdrop-filter: blur(12px) !important;
        border-radius: 12px !important;
        box-shadow: 0 4px 16px rgba(255, 145, 0, 0.2) !important;
    }
    ...
    .alert-medium { 
        ...
        background: linear-gradient(135deg, 
            ...
            rgba(255, 214, 0, 0.06) 100%) !important;
        backdrop-filter: blur(12px) !important;
        -webkit-backdrop-filter: blur(12px) !important;
        border-radius: 12px !important;
        box-shadow: 0 4px 16px rgba(255, 214, 0, 0.2) !important;
    }
    ...
    .alert-info { 
        ...
        background: linear-gradient(135deg, 
            ...
            rgba(41, 121, 255, 0.06) 100%) !important;
        backdrop-filter: blur(12px) !important;
        -webkit-backdrop-filter: blur(12px) !important;
        border-radius: 12px !important;
        box-shadow: 0 4px 16px rgba(41, 121, 255, 0.2) !important;
    }
    </style>
    """
